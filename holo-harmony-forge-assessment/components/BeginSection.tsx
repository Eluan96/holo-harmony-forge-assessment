    ...
    <section className="bg-gradient-to-r from-blue-600 to-cyan-500 py-24 px-80 sm:py-32">
      ...
      >
        ...
        <motion.div
          ...
          variants={itemVariants}
        >
          <button className="flex items-center justify-center gap-x-2 bg-white text-[#00429E] font-bold px-8 py-3 rounded-lg shadow-lg hover:bg-[#00429E] hover:text-white transition-colors duration-300">
            <span>Get Started Now</span>
            <MoveRight />
          </button>

          <button className="bg-[#00429E] w-48 h-12 text-white hover:text-[#00429E] rounded-lg shadow-lg hover:bg-white transition-colors duration-300 hidden sm:block">
